...
public:
	...
	static Uint32 getColorInt(const SDL_Color *_col);
	static void drawCircle(SDL_Renderer *_ren, const SDL_Point *_center, const SDL_Rect *_bounds, Uint16 _rad, const SDL_Color *_col);
